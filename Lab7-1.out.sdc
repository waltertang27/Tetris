## Generated SDC file "Lab7-1.out.sdc"
...
create_clock -name {lab7_soc:u0|vga_text_avl_interface:vga_text_mode_controller|vga_controller:vga|clkdiv} -period 10.000 -waveform { 0.000 5.000 } 
...
create_generated_clock -name {u0|sdram_pll|sd1|pll7|clk[1]} -source [get_pins {u0|sdram_pll|sd1|pll7|inclk[0]}] -duty_cycle 50/1 -multiply_by 1 -phase -18/1 -master_clock {MAX10_CLK1_50} [get_pins {u0|sdram_pll|sd1|pll7|clk[1]}] 
