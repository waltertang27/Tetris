...
int rotateLeft(int blockState, int blockX, int blockY){
	...
	case 8:
		if(blockX > 0 && blockX < 8){
			if(gameBoard[blockY][blockX + 1] == 0 && gameBoard[blockY + 2][blockX + 1] == 0 && gameBoard[blockY + 2][blockX + 2] == 0){
				newState = 11;
				gameBoard[blockY][blockX + 1] = -3;
				gameBoard[blockY + 2][blockX + 1] = -3;
				gameBoard[blockY + 2][blockX + 2] = -3;
				gameBoard[blockY + 1][blockX] = 0;
				gameBoard[blockY + 1][blockX + 2] = 0;
				gameBoard[blockY + 2][blockX] = 0;
			}
	...
	case 9:
		if(blockX > 0 && blockX < 8){
			if(gameBoard[blockY + 1][blockX] == 0 && gameBoard[blockY + 1][blockX + 2] == 0 && gameBoard[blockY + 2][blockX] == 0){
				newState = 8;
				gameBoard[blockY + 1][blockX] = -3;
				gameBoard[blockY + 1][blockX + 2] = -3;
				gameBoard[blockY + 2][blockX] = -3;
				gameBoard[blockY][blockX] = 0;
				gameBoard[blockY][blockX + 1] = 0;
				gameBoard[blockY + 2][blockX + 1] = 0;
			}
	...
	case 10:
		if(blockX > 0 && blockX < 8){
			if(gameBoard[blockY][blockX] == 0 && gameBoard[blockY][blockX + 1] == 0 && gameBoard[blockY + 2][blockX + 1] == 0){
				newState = 9;
				gameBoard[blockY][blockX] = -3;
				gameBoard[blockY][blockX + 1] = -3;
				gameBoard[blockY + 2][blockX + 1] = -3;
				gameBoard[blockY][blockX + 2] = 0;
				gameBoard[blockY + 1][blockX] = 0;
	...
	case 11:
		if(blockX > 0 && blockX < 8){
			if(gameBoard[blockY][blockX + 2] == 0 && gameBoard[blockY + 1][blockX] == 0 && gameBoard[blockY + 1][blockX + 2] == 0){
				newState = 10;
				gameBoard[blockY][blockX + 2] = -3;
				gameBoard[blockY + 1][blockX] = -3;
				gameBoard[blockY + 1][blockX + 2] = -3;
				gameBoard[blockY][blockX + 1] = 0;
				gameBoard[blockY + 2][blockX + 1] = 0;
	...
	case 12:
		if(blockX > 0 && blockX < 8){
			if(gameBoard[blockY][blockX + 1] == 0 && gameBoard[blockY + 2][blockX + 2] == 0){
				newState = 13;
				gameBoard[blockY][blockX + 1] = -5;
				gameBoard[blockY + 2][blockX + 2] = -5;
				gameBoard[blockY + 2][blockX] = 0;
				gameBoard[blockY + 2][blockX + 1] = 0;
			}
		}
	...
	case 13:
		if(blockX > 0 && blockX < 8){
			if(gameBoard[blockY + 2][blockX] == 0 && gameBoard[blockY + 2][blockX + 1] == 0){
				newState = 12;
				gameBoard[blockY + 2][blockX] = -5;
				gameBoard[blockY + 2][blockX + 1] = -5;
				gameBoard[blockY][blockX + 1] = 0;
				gameBoard[blockY + 2][blockX + 2] = 0;
			}
		}
	...
	case 14:
		if(blockX > 0 && blockX < 8){
			if(gameBoard[blockY][blockX + 1] == 0){
				newState = 17;
				gameBoard[blockY][blockX + 1] = -6;
				gameBoard[blockY + 1][blockX] = 0;
			}
		}
		break;
	case 15:
		if(blockX > 0 && blockX < 8){
			if(gameBoard[blockY + 1][blockX + 2] == 0){
				newState = 14;
				gameBoard[blockY + 1][blockX + 2] = -6;
				gameBoard[blockY][blockX + 1] = 0;
			}
		}
		break;
	case 16:
		if(blockX > 0 && blockX < 8){
			if(gameBoard[blockY + 2][blockX + 1] == 0){
				newState = 15;
				gameBoard[blockY + 2][blockX + 1] = -6;
				gameBoard[blockY + 1][blockX + 2] = 0;
			}
		}
		break;
	case 17:
		if(blockX > 0 && blockX < 8){
			if(gameBoard[blockY + 1][blockX] == 0){
				newState = 16;
				gameBoard[blockY + 1][blockX] = -6;
				gameBoard[blockY + 2][blockX + 1] = 0;
			}
		}
		break;
	case 18:
		if(blockX > 0 && blockX < 8){
			if(gameBoard[blockY][blockX + 2] == 0 && gameBoard[blockY + 1][blockY + 2] == 0){
				newState = 19;
				gameBoard[blockY][blockX + 2] = -7;
				gameBoard[blockY + 1][blockY + 2] = -7;
				gameBoard[blockY + 1][blockX] = 0;
				gameBoard[blockY + 2][blockX + 2] = 0;
			}
		}
	...
	case 19:
		if(blockX > 0 && blockX < 8){
			if(gameBoard[blockY + 1][blockX] == 0 && gameBoard[blockY + 2][blockX + 2] == 0){
				newState = 18;
				gameBoard[blockY][blockX + 2] = 0;
				gameBoard[blockY + 1][blockY + 2] = 0;
				gameBoard[blockY + 1][blockX] = -7;
				gameBoard[blockY + 2][blockX + 2] = -7;
			}
		}
		break;
	default:
